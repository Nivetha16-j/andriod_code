...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      ...
      // Refresh normal cart after physical conversion state is known.
  ...
  Future<void> _sendPhysicalOrder() async {
    ...
    // ============================================================
    // GET SHIPPING ADDRESS DYNAMICALLY
    // ============================================================
  ...
  Future<void> _placeNormalOrder() async {
    ...
    // ==========================================================
    // IMPORTANT:
    // NORMAL CHECKOUT MUST CHECK cartItems.
    //
    // DO NOT use physicalProvider.physicalCart here.
    // ==========================================================
  ...
  Widget _buildNormalOrderSummary(
    ...
    // Use the same delivery method shown in SummaryWidget.
    final String deliveryMethod = isDigital
        ? "Digital"
        : provider.selectedDeliveryMethod;

    // Use the coupon already stored in CartProvider.
